...
const pages = [
  ...
  { endpoint: "flk", name: "Form Laporan Kerja" },
  { endpoint: "report", name: "Report" },
];
const settings = ["Profile", "Logout"];
const menu_flk = [
  { name: "Form Dengan Nomor Navision", endpoint: "/add" },
  { name: "Form Dengan Nomor Seri", endpoint: "/add-no-barang" },
];
